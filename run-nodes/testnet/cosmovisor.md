...
Cosmovisor is process manager for Cosmos-SDK application binaries that monitors the governance module for incoming chain upgrade proposals.{synopsis}
...
5. Create the service for the Cosmovisor
    ...
    ExecStart=/home/<your_user>/go/bin/cosmovisor run start --home /home/<your_user>/.humansd
    Restart=on-failure
    RestartSec=3
    Environment="DAEMON_NAME=humansd"
    Environment="DAEMON_HOME=/home/<your_user>/.humansd"
...
1. Create a service file
    ...
    User=<your_user>
    Group=<your_user_group>
    ExecStart=/home/<your_user>/go/bin/humansd start --home /home/<your_user>/.humansd
    Restart=on-failure
